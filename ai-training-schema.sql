-- AI Training and Learning System Schema
...
CREATE TABLE IF NOT EXISTS public.ai_conversations (
  ...
  question_embedding VECTOR(1536), -- OpenAI embedding for semantic search
...
COMMENT ON COLUMN public.ai_conversations.question_embedding IS 'Vector embedding for semantic similarity search';
